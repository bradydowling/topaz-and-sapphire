...
if ( !isset( $infashion_option ) && file_exists( dirname( __FILE__ ) . '/functions/theme-functions/theme-options.php' ) ) {
...
function warrior_required_plugins() {
	...
	$string = array(
		'page_title' => __( 'Install Required Plugins', 'infashion' ),
		'menu_title' => __( 'Install Plugins', 'infashion' ),
		'installing' => __( 'Installing Plugin: %s', 'infashion' ),
		'oops' => __( 'Something went wrong with the plugin API.', 'infashion' ),
		...
		'return' => __( 'Return to Required Plugins Installer', 'infashion' ),
		'plugin_activated' => __( 'Plugin activated successfully.', 'infashion' ),
		'complete' => __( 'All plugins installed and activated successfully. %s', 'infashion' ),
		'nag_type' => 'updated'
	);

	$theme_text_domain = 'infashion';
