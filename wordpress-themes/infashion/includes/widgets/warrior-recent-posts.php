...
class Warrior_Recent_Posts extends WP_Widget {
	...
	function Warrior_Recent_Posts() {
		$widget_ops  = array( 'classname' => 'warrior_recent_posts', 'description' => __( 'Display recent posts with thumbnails.', 'infashion' ) );
		$control_ops = array( 'id_base' => 'warrior_recent_posts' );

		$this->WP_Widget( 'warrior_recent_posts', __( 'Warrior Recent Posts', 'infashion' ), $widget_ops, $control_ops );
	}
...
<?php
	...
	function form( $instance ) {
		$instance = wp_parse_args( (array) $instance, array('warrior_recent_posts_title' => __('Recent Posts', 'infashion'), 'warrior_recent_posts_count' => '5', 'warrior_recent_words_count' => '30', 'warrior_recent_excerpt_count' => '90') );
	?>
        <p>
            <label for="<?php echo $this->get_field_id( 'warrior_recent_posts_title' ); ?>"><?php _e('Widget Title:', 'infashion'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'warrior_recent_posts_count' ); ?>"><?php _e('Number of posts to show:', 'infashion'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'warrior_recent_words_count' ); ?>"><?php _e('Post Title Limiter', 'infashion'); ?></label>
            ...
            <p><small><?php _e('The post title will be trim after reaching the number of characters defined.', 'infashion'); ?></small></p>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id( 'warrior_recent_excerpt_count' ); ?>"><?php _e('Post Excerpt Limiter', 'infashion'); ?></label>
            ...
            <p><small><?php _e('The post excerpt in the first post will be trim after reaching the number of characters defined.', 'infashion'); ?></small></p>
        </p>
	<?php
	}
}
